...
;;
;; Racket-optimized version with flush-output for better interactive display
...
;; Racket flush-output for better interactive display
(define (flush-output-port)
  ;; Use Racket's flush-output for proper interactive behavior
  (flush-output))
